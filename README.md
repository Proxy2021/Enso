...
### 🔍 Research Engine
Research any topic in any language. Two-phase streaming pipeline: key findings appear in ~19 seconds, full analysis (sections, media, books, movies, contradictions, gap analysis) completes in ~30s. Follow-up questions, side-by-side comparisons, deep dives, AI podcast generation, and PDF export. Complex topics auto-escalate to deep research via Claude Code.
