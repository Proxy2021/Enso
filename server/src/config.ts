...
export const CLAUDE_HEARTBEAT_TIMEOUT_ORCH_MS = 600_000; // 10 min — orchestration tasks (auto-resume on timeout)
export const CLAUDE_HEARTBEAT_MAX_RETRIES = 2; // max auto-resume attempts on heartbeat timeout
