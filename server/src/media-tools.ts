...
const THUMB_DIR = join(homedir(), ".enso", "apps", "multimedia", "thumbs");
...
// ── Metadata Store ────────────────────────────────────────────────────────
// Persistent JSON file at ~/.enso/apps/multimedia/store.json

const STORE_DIR = join(homedir(), ".enso", "apps", "multimedia");
...
export function createMediaTools(): EnsoAgentTool[] {
  return [
