...
const en: Record<string, string> = {
  ...
  "op.savingToWiki": "Saving to Wiki",
  "op.savedToWiki": "Saved to Wiki",
  "op.wikiIngestFailed": "Wiki ingest failed",
  "op.importingToWiki": "Importing data sources to Wiki",
  "op.importedToWiki": "Imported to Wiki",
  ...
  "catalog.clawhub": "ClawHub skill store: browse, search, install and manage OpenClaw skills",
...
const zh: Record<string, string> = {
  ...
  "op.savingToWiki": "正在保存到知识库",
  "op.savedToWiki": "已保存到知识库",
  "op.wikiIngestFailed": "知识库写入失败",
  "op.importingToWiki": "正在导入数据源到知识库",
  "op.importedToWiki": "已导入到知识库",
  ...
  "catalog.clawhub": "ClawHub 技能商店：浏览、搜索、安装和管理 OpenClaw 技能",
