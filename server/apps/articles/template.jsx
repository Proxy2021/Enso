        ...
        {related.length > 0 && (
          <UICard style={{ padding: "14px" }}>
            ...
            <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
              {related.map(function(r) { return <Button key={r.entityId} variant="outline" size="sm" style={{ fontSize: "10px" }} onClick={function() { onAction("view_entity", { entityId: r.entityId }); }}>{r.title} ({r.source})</Button>; })}
            </div>
          </UICard>
        )}
      </div>
