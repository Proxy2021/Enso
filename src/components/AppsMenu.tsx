  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={handleOpen}
        disabled={disabled}
        className={`flex items-center gap-1 px-2 py-1 text-sm rounded-md border transition-all duration-150 ${
          disabled
        ...
        <div className="absolute right-0 mt-1 w-72 rounded-lg border border-gray-700 bg-gray-800 shadow-lg z-50 overflow-hidden">
              ...
              {apps.map((app) => {
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.5">
                          <button
                            ...
                            className="text-[10px] px-2 py-0.5 rounded bg-gray-700 text-gray-300 hover:bg-gray-600 transition-all duration-150"
                          >
                            Cancel
                          </button>
                          <button
                            onClick={handleDeleteConfirm}
                            className="text-[10px] px-2 py-0.5 rounded bg-red-600 text-white hover:bg-red-500 transition-all duration-150"
                          >
                            Delete
                          </button>
                        </div>
                ...
                return (
                  <button
                    ...
                    className="w-full text-left px-3 py-2 hover:bg-gray-700/50 transition-all duration-150 border-b border-gray-700/20 last:border-b-0"
                  >
          ...
          <div className="border-t border-gray-700/50 flex">
            {ensoProjectPath && (
              <button
                onClick={handleCode}
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs text-gray-400 hover:text-gray-200 hover:bg-gray-700/50 transition-all duration-150 border-r border-gray-700/50"
              >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs text-gray-400 hover:text-gray-200 hover:bg-gray-700/50 transition-all duration-150"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
