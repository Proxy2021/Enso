 ...
 *
 * Files:
 *   ~/.openclaw/enso-action.log   — NDJSON, all actions/errors/tools (rotate at 1000 lines)
 *   ~/.openclaw/enso-fixes.json   — JSON array of bug fix records
 */
...
const BASE_DIR = join(homedir(), ".openclaw");
const LOG_PATH = join(BASE_DIR, "enso-action.log");
const FIXES_PATH = join(BASE_DIR, "enso-fixes.json");
