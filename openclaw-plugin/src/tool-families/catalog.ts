...
export const TOOL_FAMILY_CAPABILITIES: ToolFamilyCapability[] = [
  ...
  },
  {
    ...
    actionSuffixes: ["list_drives", "list_directory", "read_text_file", "open_file", "open_external", "stat_path", "search_paths", "create_directory", "rename_path", "delete_path", "move_path"],
